...
rscript_path="/home/combine_matrices.R"  # Specify the correct path to the R script
...
cellranger_index_dir="${genome_dir}/${genome_base}_cellranger_index/"

if [ ! -f "$cellranger_index_dir/star/Genome" ]; then
...
for sample_name in "${!samples[@]}"; do
  ...
  $cellranger_exe count --transcriptome=$cellranger_index_dir \
